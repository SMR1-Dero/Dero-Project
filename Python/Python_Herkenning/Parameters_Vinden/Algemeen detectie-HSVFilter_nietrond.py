...
cv2.createTrackbar('hsvunder1','Trackbar',0,255,nothing)#5,74,40,45,215,125
cv2.createTrackbar('hsvunder2','Trackbar',80,255,nothing)
cv2.createTrackbar('hsvunder3','Trackbar',90,255,nothing)
cv2.createTrackbar('hsvupper1','Trackbar',255,255,nothing)
cv2.createTrackbar('hsvupper2','Trackbar',255,255,nothing)
cv2.createTrackbar('hsvupper3','Trackbar',125525,255,nothing)
point = (400, 300)
